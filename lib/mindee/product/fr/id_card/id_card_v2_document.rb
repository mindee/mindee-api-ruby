      ...
      module IdCard
        ...
        class IdCardV2Document < Mindee::Parsing::Common::Prediction
          ...
          def initialize(prediction, page_id)
            ...
            @alternate_name = Parsing::Standard::StringField.new(prediction['alternate_name'], page_id)
            @authority = Parsing::Standard::StringField.new(prediction['authority'], page_id)
            ...
            @card_access_number = Parsing::Standard::StringField.new(prediction['card_access_number'], page_id)
            ...
            @gender = Parsing::Standard::StringField.new(prediction['gender'], page_id)
