      ...
      module Payslip
        ...
        class PayslipV2PayDetail < Mindee::Parsing::Standard::FeatureField
          ...
          def printable_values
            printable = {}
            printable[:gross_salary] = @gross_salary.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@gross_salary)
            printable[:gross_salary_ytd] = @gross_salary_ytd.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@gross_salary_ytd)
            printable[:income_tax_rate] = @income_tax_rate.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@income_tax_rate)
            printable[:income_tax_withheld] =
              @income_tax_withheld.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@income_tax_withheld)
            printable[:net_paid] = @net_paid.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@net_paid)
            printable[:net_paid_before_tax] =
              @net_paid_before_tax.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@net_paid_before_tax)
            printable[:net_taxable] = @net_taxable.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@net_taxable)
            printable[:net_taxable_ytd] = @net_taxable_ytd.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@net_taxable_ytd)
            printable[:total_cost_employer] =
              @total_cost_employer.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@total_cost_employer)
            printable[:total_taxes_and_deductions] =
              @total_taxes_and_deductions.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@total_taxes_and_deductions)
            printable
          end
