    ...
    module BillOfLading
      ...
      class BillOfLadingV1CarrierItem < Mindee::Parsing::Standard::FeatureField
        ...
        def printable_values
          ...
          printable[:gross_weight] = @gross_weight.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@gross_weight)
          printable[:measurement] = @measurement.nil? ? '' : Parsing::Standard::BaseField.float_to_string(@measurement)
