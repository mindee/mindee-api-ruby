    ...
    module Product
      module NutritionFactsLabel
        ...
        class NutritionFactsLabelV1Document < Mindee::Parsing::Common::Prediction
          ...
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1Calorie]
          attr_reader :calories
          # The amount of cholesterol in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1Cholesterol]
          attr_reader :cholesterol
          # The amount of dietary fiber in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1DietaryFiber]
          attr_reader :dietary_fiber
          # The amount of nutrients in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1Nutrients]
          attr_reader :nutrients
          # The amount of protein in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1Protein]
          attr_reader :protein
          ...
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1Sodium]
          attr_reader :sodium
          # The total amount of carbohydrates in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1TotalCarbohydrate]
          attr_reader :total_carbohydrate
          # The total amount of fat in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1TotalFat]
          attr_reader :total_fat
          # The total amount of sugars in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1TotalSugar]
          attr_reader :total_sugars
          # The amount of trans fat in the product.
          # @return [Mindee::V1::Product::NutritionFactsLabel::NutritionFactsLabelV1TransFat]
