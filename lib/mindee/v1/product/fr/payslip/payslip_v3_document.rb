      ...
      module FR
        module Payslip
          ...
          class PayslipV3Document < Mindee::Parsing::Common::Prediction
            ...
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3Employee]
            attr_reader :employee
            # Information about the employer.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3Employer]
            attr_reader :employer
            # Information about the employment.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3Employment]
            attr_reader :employment
            # Information about paid time off.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3PaidTimeOffs]
            attr_reader :paid_time_off
            # Detailed information about the pay.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3PayDetail]
            attr_reader :pay_detail
            # Information about the pay period.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3PayPeriod]
            attr_reader :pay_period
            # Detailed information about the earnings.
            # @return [Mindee::V1::Product::FR::Payslip::PayslipV3SalaryDetails]
            ...
            def initialize(prediction, page_id)
              super
              @bank_account_details = Product::FR::Payslip::PayslipV3BankAccountDetail.new(
                prediction['bank_account_details'],
                page_id
              )
              @employee = Product::FR::Payslip::PayslipV3Employee.new(
                prediction['employee'],
                page_id
              )
              @employer = Product::FR::Payslip::PayslipV3Employer.new(
                prediction['employer'],
                page_id
              )
              @employment = Product::FR::Payslip::PayslipV3Employment.new(
              ...
              @pay_period = Product::FR::Payslip::PayslipV3PayPeriod.new(
