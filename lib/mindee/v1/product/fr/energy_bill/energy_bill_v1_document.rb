      ...
      module FR
        module EnergyBill
          ...
          class EnergyBillV1Document < Mindee::Parsing::Common::Prediction
            ...
            # @return [Mindee::V1::Product::FR::EnergyBill::EnergyBillV1EnergySupplier]
            ...
            # @return [Mindee::V1::Product::FR::EnergyBill::EnergyBillV1Subscriptions]
            ...
            def initialize(prediction, page_id)
              ...
              @subscription = Product::FR::EnergyBill::EnergyBillV1Subscriptions.new(prediction['subscription'],
                                                                                     page_id)
