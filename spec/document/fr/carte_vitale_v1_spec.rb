...
describe Mindee::Product::FR::CarteVitaleV1 do
  context 'A Carte Vitale V1' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Document.new(Mindee::Product::FR::CarteVitaleV1, response['document']).inference
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Document.new(Mindee::Product::FR::CarteVitaleV1, response['document'])
