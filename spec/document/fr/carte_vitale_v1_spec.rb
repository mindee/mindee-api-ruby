...
describe Mindee::Product::FR::CarteVitale::CarteVitaleV1 do
  ...
  context 'A Carte Vitale V1' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::CarteVitale::CarteVitaleV1,
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::CarteVitale::CarteVitaleV1,
                                                       response['document'])
