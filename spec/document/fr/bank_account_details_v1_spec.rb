...
describe Mindee::Product::FR::BankAccountDetails::BankAccountDetailsV1 do
  context 'A Bank Account Details V1' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::BankAccountDetails::BankAccountDetailsV1,
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::BankAccountDetails::BankAccountDetailsV1,
                                                       response['document'])
