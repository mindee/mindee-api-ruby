...
describe Mindee::Product::FR::IdCard::IdCardV1 do
  context 'A Carte Nationale d\'Identité V1' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::IdCard::IdCardV1,
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Parsing::Common::Document.new(Mindee::Product::FR::IdCard::IdCardV1, response['document'])
