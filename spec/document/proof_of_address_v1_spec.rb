...
describe Mindee::Product::ProofOfAddressV1 do
  context 'A Proof of Address V1' do
    it 'should load an empty document prediction' do
      response = load_json(DIR_PROOF_OF_ADDRESS_V1, 'empty.json')
      inference = Mindee::Document.new(Mindee::Product::ProofOfAddressV1, response['document']).inference
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Document.new(Mindee::Product::ProofOfAddressV1, response['document'])
