...
describe Mindee::Product::EU::LicensePlate::LicensePlateV1 do
  context 'A License Plate V1' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Parsing::Common::Document.new(Mindee::Product::EU::LicensePlate::LicensePlateV1,
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Parsing::Common::Document.new(Mindee::Product::EU::LicensePlate::LicensePlateV1,
                                                       response['document'])
