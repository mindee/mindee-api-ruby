...
describe Mindee::Product::ReceiptV5 do
  context 'A Expense Receipt V5' do
    it 'should load an empty document prediction' do
      ...
      inference = Mindee::Document.new(Mindee::Product::ReceiptV5, response['document']).inference
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Document.new(Mindee::Product::ReceiptV5, response['document'])
