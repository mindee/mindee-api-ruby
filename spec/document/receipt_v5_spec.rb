...
describe Mindee::Prediction::ReceiptV5 do
  context 'A Expense Receipt V5' do
    it 'should load an empty document prediction' do
      response = load_json(DIR_RECEIPT_V5, 'empty.json')
      inference = Mindee::Document.new(Mindee::Prediction::ReceiptV5, response['document']).inference
    ...
    it 'should load a complete document prediction' do
      ...
      document = Mindee::Document.new(Mindee::Prediction::ReceiptV5, response['document'])
