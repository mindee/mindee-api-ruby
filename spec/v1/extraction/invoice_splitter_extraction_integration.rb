...
if Mindee::Dependency.heavy_available? # Can't be bypassed by tag as otherwise it will try to load the PDF module.
  describe 'PDF Invoice Extraction (Strict Mode)', :full_deps do
    ...
    it 'should extract invoices from a PDF (strict mode)' do
      ...
      pdf_extractor = Mindee::PDF::PDFExtractor.new(invoice_splitter_input)
