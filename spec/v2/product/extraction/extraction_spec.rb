...
describe 'extraction' do
  ...
  def load_v2_extraction_inference(resource_path)
  ...
  describe 'simple' do
    it 'loads a blank extraction inference with valid properties' do
      response = load_v2_extraction_inference(blank_path)
    ...
    it 'loads a complete inference with valid properties' do
      response = load_v2_extraction_inference(complete_path)
  ...
  describe 'nested' do
    it 'loads a deep nested object' do
      response = load_v2_extraction_inference(deep_nested_field_path)
      fields = response.inference.result.fields
  ...
  describe 'standard field types' do
    def load_standard_fields
      response = load_v2_extraction_inference(standard_field_path)
  ...
  describe 'raw_text' do
    it 'exposes raw texts' do
      response = load_v2_extraction_inference(raw_text_json_path)
  ...
  describe 'field locations and confidence' do
    it 'are properly exposed' do
      response = load_v2_extraction_inference(location_field_path)
  ...
  describe 'RAG Metadata' do
    it 'when matched' do
      response = load_v2_extraction_inference(rag_matched_path)
      expect(response.inference).not_to be_nil
    ...
    it 'when not matched' do
      response = load_v2_extraction_inference(rag_not_matched_path)
      expect(response.inference).not_to be_nil
  ...
  describe 'text context' do
    it 'when enabled' do
      response = load_v2_extraction_inference(text_context_path)
      expect(response.inference).not_to be_nil
